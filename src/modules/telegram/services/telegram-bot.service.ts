...
export class TelegramBotService implements OnModuleInit {
  ...
  onModuleInit() {
    setTimeout(() => {
      ...
      this.logger.log('Telegram bot initialized (staggered-new)');
    }, 5000);
  }
 ...
 async processTextMessages(msg: TelegramBot.Message, msgText: string) {
    ...
    } else if (intent.isListReminder && intent.confidence > confidenceThreshold) {
...
📝 **Journaling**:  
Send me text messages or 🎤 voice messages — I'll save them as journal entries  
